    ...
    return (
        <div className="left-panel" id={isPanelRolledUp ? 'rolled-up' : null}>
            ...
            <div className="navigation-buttons">
                <Link to="/" className="navigation-button" id={useIsActiveButton('')} state={useIsCurrentRoute('') ? "active" : ""}>
                    <img src={useIsCurrentRoute('') ? home_active : home_passive} draggable="false" alt="H" />
                    {/* <nav>{t('cloud.navigation.home')}</nav> */}
                </Link>
                <Link to="/explore" className="navigation-button" id={useIsActiveButton('explore')} state={useIsCurrentRoute('explore') ? "active" : ""}>
                ...
                <Link to="/gallery" className="navigation-button" id={useIsActiveButton('gallery')} state={useIsCurrentRoute('gallery') ? "active" : ""}>
                    <img src={useIsCurrentRoute('gallery') ? gallery_active : gallery_passive} draggable="false" alt="G" />
                    {/* <nav>{t('cloud.navigation.gallery')}</nav> */}
                </Link>
                <Link to="/music" className="navigation-button" id={useIsActiveButton('music')} state={useIsCurrentRoute('music') ? "active" : ""}>
                    <img src={useIsCurrentRoute('music') ? music_active : music_passive} draggable="false" alt="M" />
                    {/* <nav>{t('cloud.navigation.music')}</nav> */}
                </Link>
                <Link to="/messages" className="navigation-button" id={useIsActiveButton('messages')} state={useIsCurrentRoute('messages') ? "active" : ""}>
                ...
                <Link to="/profile" className="navigation-button" id={useIsActiveButton('profile')} state={useIsCurrentRoute('profile') ? "active" : ""}>
            ...
            <div className="progress-bar-wrapper" isrolledup={isPanelRolledUp ? 'rolled-up' : null}>
                <div to="/profile" className="navigation-button">
                    <img src={more} draggable="false" alt="P" />
                    {/* <nav>{t('cloud.navigation.profile')}</nav> */}
                </div>
                {/* 
